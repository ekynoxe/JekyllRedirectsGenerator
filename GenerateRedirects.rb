...
#
# Whenever you use Jekyll generate or preview, the redirects file will be
#   created in the source folder. The default file name is "htaccess_redirects"
#
module Jekyll
    ...
    class RedirectsGenerator < Generator
        ...
        @@sourceDomain = ""
        @@targetDomain = "<your target domain here>"
